      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
        <div className="bg-[#250020] rounded-lg p-3">
          ...
          <div className="text-lg font-medium">
            {stats.loading ? (
              <span className="h-5 w-24 bg-white/10 animate-pulse rounded inline-block"></span>
            ) : (
        ...
        <div className="bg-[#250020] rounded-lg p-3">
          ...
          <div className={`text-lg font-medium ${stats.priceChange24h && stats.priceChange24h > 0 ? 'text-green-400' : 'text-red-400'}`}>
            {stats.loading ? (
              <span className="h-5 w-16 bg-white/10 animate-pulse rounded inline-block"></span>
            ) : (
